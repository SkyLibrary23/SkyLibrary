...
public class MyPageController {
	 ...
	 * 
	 * System.out.println("Out MyPageController (value=/wishCheck)"); HttpSession
	 * session = req.getSession(); SessionVO sessionVO =
	 * (SessionVO)session.getAttribute("user"); // STRING USERID =
	 * SESSIONVO.GETUSERID();
	 * 
	 ...
	 * HttpSession session = req.getSession(true);
	 * 
	 * SessionVO sessionVO = (SessionVO)session.getAttribute("user"); UserVO vo =
	 * userService.userInfoOk(sessionVO); model.addAttribute("userInfo",vo);
	 * 
